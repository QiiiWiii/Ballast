...
pub async fn create_replay_result(
    ...
    let inserted = sqlx::query(
        ...
        INSERT INTO replay_runs (
            ...
            strategy_snapshot, instrument_snapshot, data_snapshot, coverage_snapshot,
            request_fingerprint,
...
fn row_to_run(row: &sqlx::postgres::PgRow) -> Result<StoredReplayRun, sqlx::Error> {
    Ok(StoredReplayRun {
        ...
        instrument_snapshot: row.try_get("instrument_snapshot")?,
